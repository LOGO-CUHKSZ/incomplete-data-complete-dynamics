...
def main(conf_path: str, is_coding_mode: bool = False) -> str:
    ...
    if config.learning.model == 'ldpv':
        sampling_configs = [
            ...
            {'steps': 200, 'sampling': {'random_context': True}},
            {'steps': 200, 'sampling': {'random_context': False}},
            {'steps': 200, 'sampling': {'weighted': 'quad', 'random_context': False}},
            {'steps': 200, 'sampling': {'weighted': 'quad', 'random_context': True}},
            {'steps': 200, 'sampling': {'weighted': 'linear', 'random_context': False}},
            {'steps': 200, 'sampling': {'weighted': 'linear', 'random_context': True}}
        ]
...
def get_arg(
    ...
    match learning['model']:
        case 'ldpv':
            assert 0 < learning['context_ratio'] < 1
            assert learning['query_ratio'] > 0
        case 'dsm':
            pass
        case _: raise NotImplementedError()
...
if __name__ == '__main__':
    ...
    # learning_config = {'model': 'dsm'}
    # sampling_config = {'steps': 1}
    ...
    # for model_config in [
    #     {'model': 'karras', 'network': {'hidden_size': 32}},
    #     # {'model': 'fno', 'network': {'hidden_channels': 32}}
    # ]:
    #     main(*get_arg(
    #         sde=sde_config,
    #         model=model_config,
    ...
    #         dataset=f'data/ns_uniform_{p}.h5',
